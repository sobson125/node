...
const forecast = (longitude, latitude, callback) => {
  const url = 'http://api.weatherstack.com/current?access_key=d38f133b7a0328dcef484928d48f081c&query='+encodeURIComponent(longitude) +',' + encodeURIComponent(latitude);
